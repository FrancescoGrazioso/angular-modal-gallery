 ...
 */
export const fg_DEFAULT_SIZE: Size = { height: 'auto', width: '30px' };

/**
 * Default close button object
 */
export const fg_DEFAULT_BTN_CLOSE: ButtonConfig = {
 ...
 */
export const fg_DEFAULT_BTN_DOWNLOAD: ButtonConfig = {
 ...
 */
export const fg_DEFAULT_BTN_EXTURL: ButtonConfig = {
...
//  */
// export const fg_DEFAULT_BTN_REFRESH: ButtonConfig = {
 ...
 */
export const fg_DEFAULT_BTN_DELETE: ButtonConfig = {
 ...
 */
export const fg_DEFAULT_BTN_FULL_SCREEN: ButtonConfig = {
